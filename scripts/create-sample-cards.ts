...
const mock2a = "/Users/macbook/.gemini/antigravity-ide/brain/eab92aab-919d-49d8-86dd-983c8603de80/nurse_mug_mockup_1786373484880.png";
...
export async function createSampleCards() {
  console.log("🔍 Đang kiểm tra kết nối Trello & Đăng NHIỀU ảnh mockup thật cho mỗi SKU...");
  ...
  console.log(`📋 Sẽ đăng các thẻ kèm NHIỀU ảnh mockup vào cột: "${reviewList.name}" (ID: ${reviewList.id})`);
  ...
  const sampleCards = [
    ...
    },
    {
      ...
      mockups: [
        { file: mock2a, name: "3CVT0708MUG02_mockup_main.png" },
  ...
  console.log("\n🎉 HOÀN THÀNH ĐĂNG TẤT CẢ THẺ KÈM NHIỀU ẢNH MOCKUP THẬT TRÊN TRELLO!");
  return true;
}

if (require.main === module) {
  createSampleCards().catch(console.error);
}
