            ...
            <table className="w-full min-w-[1050px] text-left text-xs text-slate-700">
              <thead className="border-b border-slate-200 bg-slate-50 text-[10px] font-extrabold uppercase text-slate-500">
                <tr>
                  ...
                  <th className="px-2 py-3 text-center whitespace-nowrap w-[60px] min-w-[60px] sticky right-0 z-20 bg-slate-50 border-l border-slate-200 shadow-[-4px_0_8px_rgba(0,0,0,0.04)]">
                    Terms
                  </th>
                </tr>
              </thead>
                          ...
                          <tr className={`group transition ${isExpanded ? "bg-indigo-50/40" : "hover:bg-slate-50/80"}`}>
                            ...
                            <td className={`px-2 py-2 text-center whitespace-nowrap w-[60px] min-w-[60px] sticky right-0 z-10 border-l border-slate-200 shadow-[-4px_0_8px_rgba(0,0,0,0.04)] transition ${
                              ...
                              <button
                                ...
                                title={isExpanded ? "Đóng danh sách terms" : "Xem các customer search terms"}
                              >
                                {isExpanded ? "Đóng" : "Xem"}
                              </button>
                            </td>
